...
class DistanceUtility {
	...
	//The variable zipCodePath gets its value from user. This will be passed by main() method in Driver class
	public static String zipCodePath = null;
	...
	public DistanceUtility() throws NumberFormatException, IOException {
		...
		BufferedReader br = new BufferedReader(new FileReader(zipCodePath));
